...
import { abcOfMercy, type AbcOfMercyItem } from "@/config/devotions";
  ...
  return (
    <Reveal direction="up" delay={delay}>
      <div className="group flex flex-col space-y-5">
        ...
        <p className="text-base sm:text-lg md:text-xl leading-relaxed text-muted-foreground border-l-4 border-primary/20 pl-5">
          {item.description}
        </p>
      </div>
    </Reveal>
